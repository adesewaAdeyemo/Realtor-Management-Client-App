        ...
        <div class="card col-md-5 col-sm-11 p-5">
            ...
            <form id='form' @submit.prevent="submitForm" class="px-5">
                <div :class="{invalid: validity.fnameValidity === 'invalid'}">
                    ...
                    <input id='fname' class="form-control form-control-md" type="text" placeholder="" v-model.trim="fname" @blur="validateInput('fname')">
                    <p v-if="validity.fnameValidity === 'invalid'">Please enter a valid name!</p>
                </div>

                <div :class="{invalid: validity.lnameValidity === 'invalid'}">
                    <label for="lname">Enter Last Name</label>
                    <input id='lname' class="form-control form-control-md" type="text" placeholder="" aria-label="Name" v-model.trim="lname" @blur="validateInput('lname')">
                ...
                <div :class="{invalid: validity.phoneValidity === 'invalid'}">
                    ...
                    <input id='phone' class="form-control form-control-md" type="text" placeholder="" v-model.number="phone" @blur="validateInput('phone')">
