    ...
    <section class="center-body">
        <div class="card col-md-5 col-sm-11 p-5">
            <div class="text-center px-2">
                ...
                <h4 class="card-text mb-3 pt-3">Enter the verification code sent to your email</h4>
            </div>
            ...
            <form id='form' @submit.prevent="submitForm" class="px-5">
                <div :class="{invalid: validity.codeValidity === 'invalid'}">
                    ...
                    <input id='code' class="form-control form-control-md" type="text" placeholder="" v-model.number="code" @blur="validateInput('code')">
                ...
                <div class="text-center">
                    <button type="submit" class="btn custom-btn-bg btn-sm px-5 py-2 my-3 col-12" href="/reset-password">Submit</button>
                </div>
            </form>
